...
do
    ...
    output=$(CUDA_VISIBLE_DEVICES=1 python3 quip_hotpotqa.py --model-name "/root/llm_quant_safety/quantization/models/Mistral-7B-Instruct-v0.2-quip-2bit" --datapath "/root/llm_quant_safety/data/hotpotqa/parts/mistral_p1.csv" --savepath "/root/llm_quant_safety/data/hotpotqa/responses/parts/mistral_quip2_p1.csv" --batch-size 8 | tee /dev/tty)
