...
do
    ...
    output=$(CUDA_VISIBLE_DEVICES=1 python3 quip_hotpotqa.py --model-name "/home/data/v.moskvoretskii/quip/models/Llama-3.1-8B-Instruct-quip-sharp-4bit" --datapath "/root/llm_quant_safety/data/hotpotqa/parts/llama_p2.csv" --savepath "/root/llm_quant_safety/data/hotpotqa/responses/parts/llama_quip4_p2.csv" --batch-size 4 | tee /dev/tty)
