...
do
    ...
    output=$(python3 run_model_quip.py --model-name "/root/llm_quant_safety/quantization/models/Llama-3.1-8B-Instruct-quip-2bit" --datapath "~/llm_quant_safety/data/parts/p0.csv" --bs 128 --gpu-id 1 | tee /dev/tty)
